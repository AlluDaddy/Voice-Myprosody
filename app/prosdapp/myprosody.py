...
#     """
#     sound=c+"/"+"dataset"+"/"+"audioFiles"+"/"+p+".wav"
...
# def mysptotal(p,c):
#     z2 = run_praat_file(p,c)
#     z3=np.array(z2)
#     z4=np.array(z3)[np.newaxis]
#     z5=z4.T

#     print("divtionary")
#     dataset={"number of syllables":z5[0,:],"number of pauses":z5[1,:],"rate of speech":z5[2,:],"articulation rate":z5[3,:],"speaking duration":z5[4,:],
#                         "original duration":z5[5,:],"balance":z5[6,:],"f0_mean":z5[7,:],"f0_std":z5[8,:],"f0_median":z5[9,:],"f0_min":z5[10,:],"f0_max":z5[11,:],
...
#     # os.path.isfile(sound), "Wrong path to audio file"
#     # os.path.isfile(sourcerun), "Wrong path to praat script"
#     # os.path.isdir(path), "Wrong path to audio files"
...
#         print ("Pronunciation_posteriori_probability_score_percentageee= :%.2f" % (b))
...
#         # return ("Try again the sound of the audio was not clear",e)
#     # return ("Pronunciation_posteriori_probability_score_percentage= :%.2f" % (b))
#     return b
...
#     except Exception as e:
#         print ("myspp  Try again the sound of the audio was not clear myspp",e)
#         return("myspp  Try again the sound of the audio was not clear")
...
# #         print ("Try again the sound of the audio was not clear",ee)	
...
# # #     try:
# # #         for soundi in files:
# # #             print ("multigammaln") # This will print the info from the sound object, and objects[0] is a parselmouth.Sound object
# # #             print(sourcerun,"run")
# # #             print(soundi,"i")
# # #             print(path,"p")
# # #             objects= run_file(sourcerun, -20, 2, 0.3, "yes", soundi, path, 80, 400, 0.01, capture_output=True)
# # #             print (objects[0], "multigammaln") # This will print the info from the sound object, and objects[0] is a parselmouth.Sound object
# # #             z1=( objects[1]) # This will print the info from the textgrid object, and objects[1] is a parselmouth.Data object with a TextGrid inside
# # #             z3=z1.strip().split()
# # #             z2=np.array([z3])
# # #             result_array=np.append(result_array,[z3], axis=0)
...
# #     # sourcerun=c+"/"+"dataset"+"/"+"essen"+"/"+"myspsolution.praat" 
# #     # path=c+"/"+"dataset"+"/"+"audioFiles"+
# #     # print("adudicuiwviwvjwvwbviwebeciwec iwe ci")
# #     sound=c+"/"+"dataset"+"/"+"audioFiles"+"/"+p+".wav"
# #     sourcerun=c+"/"+"dataset"+"/"+"essen"+"/"+"myspsolution.praat"
# #     path=c+"/"+"dataset"+"/"+"audioFiles"+"/"
# #     try:
...
# #         a=np.array(db)
# #         b=np.mean(a)*100/10
# #         print ("Pronunciation_posteriori_probability_score percentage= :%.2f" % (b))
# #         return "Pronunciation_posteriori_probability_score percentage= :%.2f" % (b)
# #     except Exception as ee:
# #         print ("Try again the sound of the audio was not clear",ee)
